...
#ifndef PRINT_LEVEL
#define PRINT_LEVEL VERBOSE_ERROR
#endif /* PRINT_LEVEL */
...
#define DBG_HEX_DUMP(_pre,_buf,_len) do{ \
                           m_printf("%-30s:%04d:%-20s(): DBG "_pre, __FILE__, __LINE__, __FUNCTION__); \
...
#define DBG_HEX_DUMP(_pre,_buf,_len)
